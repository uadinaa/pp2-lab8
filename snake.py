...
class Apple:
    def __init__(self, parent_screen):
        ...
        self.image = pygame.image.load("red-apple.jpg").convert()
        self.x = 120
        self.y = 120
    ...
    def move(self):
        self.x = random.randint(1,31)*SIZE#from 24
        self.y = random.randint(1,23)*SIZE#from
...
class Game:
    ...
    def show_game_over(self):
        ...
        line2 = font.render(f"You ate {self.snake.length} apples", True, (220,20,60))
